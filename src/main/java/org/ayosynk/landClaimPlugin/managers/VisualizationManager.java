...
public class VisualizationManager {
    ...
    public void showPlayerClaims(Player player, VisualizationMode mode) {
        ...
        if (activeDisplays.containsKey(playerId)) return;
    ...
    private void spawnDisplays(Player player, Set<Edge> edges, Color color) {
        ...
        // For simplicity, LIME_STAINED_GLASS or LIGHT_BLUE depending on the config color
        ...
        for (Edge edge : edges) {
            ...
            if (lengthX == 0) lengthX = 0.1f;
            if (lengthZ == 0) lengthZ = 0.1f;
