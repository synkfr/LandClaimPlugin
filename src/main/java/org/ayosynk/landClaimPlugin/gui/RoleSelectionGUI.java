...
public class RoleSelectionGUI {
    ...
    public static void open(Player player, Claim claim, LandClaimPlugin plugin, UUID targetPlayerId,
        ...
        List<Item> contentItems = new ArrayList<>(); // Empty list for dynamically populated roles later
    ...
    private static Item buildConfigItem(RoleSelectionConfig.ItemConfig itemConfig) {
        return Item.simple(buildConfigItemBuilder(itemConfig));
    }

    private static ItemBuilder buildConfigItemBuilder(RoleSelectionConfig.ItemConfig itemConfig) {
