...
public class TrustManagementGUI {
    ...
    public static void open(Player player, Claim claim, LandClaimPlugin plugin) {
        ...
        List<Item> contentItems = new ArrayList<>(); // Empty backend logic for now
        ...
        if (contentItems.isEmpty()) {
            gui = Gui.builder()
                    ...
                    .addIngredient('+', Item.builder()
                            .setItemProvider(buildConfigItemBuilder(config.addPlayer))
    ...
    private static Item buildConfigItem(TrustManagementConfig.ItemConfig itemConfig) {
        return Item.simple(buildConfigItemBuilder(itemConfig));
    }

    private static ItemBuilder buildConfigItemBuilder(TrustManagementConfig.ItemConfig itemConfig) {
