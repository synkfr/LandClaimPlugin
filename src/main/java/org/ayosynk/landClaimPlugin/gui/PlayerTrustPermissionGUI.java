...
public class PlayerTrustPermissionGUI {
    ...
    public static void open(Player player, Claim claim, LandClaimPlugin plugin) {
        ...
        List<Item> contentItems = new ArrayList<>(); // Empty backend logic for permissions later
    ...
    private static Item buildConfigItem(PlayerTrustPermissionConfig.ItemConfig itemConfig) {
        return Item.simple(buildConfigItemBuilder(itemConfig));
    }

    private static ItemBuilder buildConfigItemBuilder(PlayerTrustPermissionConfig.ItemConfig itemConfig) {
