...
@Header("PlayerTrustPermission GUI Configuration")
...
public class PlayerTrustPermissionConfig extends OkaeriConfig {

    public String title = "Player Trust Permission";
    ...
    @Comment("Explains permission flags")
    public ItemConfig info = new ItemConfig(
            "NETHER_STAR",
            "<yellow><bold>Permission Info",
            List.of("<gray>Configure what this trusted player", "<gray>can do inside this claim."));

    @Comment("Return to previous menu")
    public ItemConfig back = new ItemConfig(
            "SPECTRAL_ARROW",
            "<yellow>Back",
            List.of("<gray>Return to Trust Management"));
